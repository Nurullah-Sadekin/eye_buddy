...
class Colorblind1 extends StatefulWidget {
  int id;
  int slide;
  Colorblind1({this.id, this.slide});
  @override
  _Colorblind1State createState() => _Colorblind1State(id: id, slide: slide);
}

class _Colorblind1State extends State<Colorblind1> {
  int id;
  int slide;
  _Colorblind1State({this.id, this.slide});
